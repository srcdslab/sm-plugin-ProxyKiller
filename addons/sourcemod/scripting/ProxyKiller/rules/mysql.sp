...
public void MySQL_OnRules(Database db, DBResultSet results, const char[] error, ProxyUser pUser)
{
	g_Logger.PrintFrame();
...
public void MySQL_OnRuleGeneric(Database db, DBResultSet results, const char[] error, any data)
{
	g_Logger.PrintFrame();
